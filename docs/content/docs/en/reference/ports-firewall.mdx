...
description: The ports PRIMEVPN uses by default and ready-made ufw / nftables rules to open them.
icon: Network
---
...
<Cards>
  <Card title="Security" href="/docs/operations/security" description="Panel hardening, custom-core IP limits, firewall rules, and BBR." />
