---
title: Clients
description: Manage PRIMEVPN clients — credentials, traffic and expiry limits, IP limits, groups, bulk actions, external links, and online status.
icon: Users
---
...
| **Limit IP**   | all                   | Max simultaneous source IPs (enforced by the PRIMEVPN custom core).        |
...
- **Limit IP** caps simultaneous source IPs inside the PRIMEVPN custom core, before outbound dispatch. You can view a client's recent IPs and clear them from the client's actions.
