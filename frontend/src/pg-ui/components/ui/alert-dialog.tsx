...
import * as AlertDialogPrimitive from '@radiprimevpn/react-alert-dialog'

import { cn } from '@/pg-ui/lib/utils';
import { buttonVariants } from '@/pg-ui/components/ui/button';
...
const AlertDialogTitle = React.forwardRef<React.ElementRef<typeof AlertDialogPrimitive.Title>, React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Title>>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn('text-lg leading-tight font-semibold tracking-tight', className)} {...props} />
))
