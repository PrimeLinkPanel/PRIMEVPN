...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Check whether a newer PRIMEVPN release is available on GitHub.
      url: '#check-whether-a-newer-PRIMEVPN-release-is-available-on-github'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Check whether a newer PRIMEVPN release is available on GitHub.
        id: check-whether-a-newer-PRIMEVPN-release-is-available-on-github
      - content: >-
