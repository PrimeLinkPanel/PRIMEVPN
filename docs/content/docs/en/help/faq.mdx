---
title: FAQ
description: Frequently asked questions about PRIMEVPN — licensing, supported systems, databases, and clients.
icon: CircleQuestionMark
---

## Is PRIMEVPN free and open source?

Yes. PRIMEVPN is open source under the GPL-3.0 license. The source is on
[GitHub](https://github.com/sh7CBAC/PRIMEVPN).
...
## How is PRIMEVPN different from primevpn?

PRIMEVPN is an enhanced fork of the original PRIMEVPN project. It adds broader protocol
...
[releases page](https://github.com/sh7CBAC/PRIMEVPN/releases).
...
[GitHub](https://github.com/sh7CBAC/PRIMEVPN/issues). For common problems, start
