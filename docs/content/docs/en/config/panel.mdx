...
description: Every PRIMEVPN panel setting — web server, TLS, display, security, and notifications — with defaults from the source.
...
`webCertFile` + `webKeyFile` — the [`primevpn` SSL menu](/docs/config/ssl-certificates)
