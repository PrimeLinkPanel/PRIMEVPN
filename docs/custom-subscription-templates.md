# PRIMEVPN Custom Subscription Templates

PRIMEVPN can render your users' subscription pages from your own custom HTML templates.

## How to use a Custom Template

1. Go to the PRIMEVPN panel settings.
2. Under **Settings → Subscription → Information**, locate the **Sub Theme Directory** field.
3. Provide the absolute path to the folder containing your template (e.g. `/etc/PRIMEVPN/sub_templates/my-theme/`).
4. Save the settings.

> **Note:** PRIMEVPN does not ship any templates by default. Create your own template folder anywhere
