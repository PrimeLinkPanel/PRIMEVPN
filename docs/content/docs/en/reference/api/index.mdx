---
title: API Reference
description: The PRIMEVPN panel REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

The PRIMEVPN panel exposes a REST API for automation. These pages are generated from
