...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: >-
        Restart the entire PRIMEVPN process after a 3-second grace period. The
        connection drops immediately; the panel comes back online ~5-10 seconds
        later.
      url: >-
        #restart-the-entire-PRIMEVPN-process-after-a-3-second-grace-period-the-connection-drops-immediately-the-panel-comes-back-online-5-10-seconds-later
    - depth: 2
      title: >-
