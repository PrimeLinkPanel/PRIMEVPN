---
title: Telegram Bot
description: Connect a Telegram bot to PRIMEVPN for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

PRIMEVPN can drive a Telegram bot for monitoring, alerts, backups, and remote
