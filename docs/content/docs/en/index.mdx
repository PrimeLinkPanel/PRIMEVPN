---
title: PRIMEVPN Documentation
description: Official documentation for PRIMEVPN — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**PRIMEVPN** is an open-source web panel for deploying and managing
...
<Callout type="info">
  New to Xray? Read [What is PRIMEVPN?](/docs/guide) first — it explains how the panel, Xray-core, and
