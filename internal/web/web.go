// Package web provides the main web server implementation for the PRIMEVPN panel,
...
import (
	...
	"github.com/mhsanaei/PRIMEVPN/v3/internal/eventbus"
	...
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/controller"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/job"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/locale"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/middleware"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/network"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/runtime"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/service"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/service/email"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/service/panel"
	"github.com/mhsanaei/PRIMEVPN/v3/internal/web/service/tgbot"
...
// Server represents the main web server for the PRIMEVPN panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("PRIMEVPN", store))
...
func (s *Server) start(restartXray bool, startTgBot bool) (err error) {
	...
	controller.SetTestTgFunc(func() error {
		...
		s.tgbotService.SendMsgToTgbotAdmins("✅ Test message from PRIMEVPN")
		return nil
	})
