---
title: 常见问题
description: 关于 PRIMEVPN 的常见问题 —— 许可协议、受支持的系统、数据库以及客户端。
icon: CircleQuestionMark
---

## PRIMEVPN 是免费且开源的吗？

是的。PRIMEVPN 基于 GPL-3.0 许可协议开源，源代码托管在
[GitHub](https://github.com/sh7CBAC/PRIMEVPN) 上。
...
## PRIMEVPN 与 primevpn 有什么区别？

PRIMEVPN 是原版 PRIMEVPN 项目的增强分支。它增加了更广泛的协议支持、更佳的稳定性、
...
[发布页面](https://github.com/sh7CBAC/PRIMEVPN/releases)。

## 我可以在哪里获取帮助？

加入官方 Telegram 频道 [@XrayUI](https://t.me/XrayUI) 获取公告与社区支持，
或在 [GitHub](https://github.com/sh7CBAC/PRIMEVPN/issues) 上提交 issue。遇到常见问题时，
