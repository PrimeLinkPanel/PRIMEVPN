...
// previous primevpn run and returns how many were killed.
//
// primevpn starts one mtg process per mtproto inbound outside its own lifecycle, and
...
// domain-fronted to the FakeTLS domain instead of proxied to Telegram. primevpn is
