---
title: PRIMEVPN 文档
description: PRIMEVPN 官方文档 —— 用于管理 Xray-core 服务器、代理、客户端与订阅的高级 Web 面板。
icon: House
---

**PRIMEVPN** 是一个开源 Web 面板，用于部署和管理
...
<Callout type="info">
  初次接触 Xray？请先阅读 [什么是 PRIMEVPN？](/docs/guide) —— 它解释了面板、Xray-core 与
  你的客户端应用如何协同工作。
</Callout>
