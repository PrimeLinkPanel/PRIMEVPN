---
title: سؤالات متداول
description: پرسش‌های پرتکرار درباره PRIMEVPN — مجوز، سیستم‌های پشتیبانی‌شده، پایگاه‌های داده و کلاینت‌ها.
icon: CircleQuestionMark
---

## آیا PRIMEVPN رایگان و متن‌باز است؟

بله. PRIMEVPN تحت مجوز GPL-3.0 متن‌باز است. کد منبع آن روی
[GitHub](https://github.com/sh7CBAC/PRIMEVPN) در دسترس است.
...
## PRIMEVPN چه تفاوتی با primevpn دارد؟

PRIMEVPN یک فورک ارتقایافته از پروژه اصلی PRIMEVPN است. این پروژه پشتیبانی گسترده‌تری از
...
[صفحه نسخه‌ها](https://github.com/sh7CBAC/PRIMEVPN/releases) مراجعه کنید.
...
[GitHub](https://github.com/sh7CBAC/PRIMEVPN/issues) باز کنید. برای مشکلات رایج، با
