# PRIMEVPN on Hetzner Cloud

Hetzner Cloud does **not** have a third-party image marketplace the way AWS does.
Ship PRIMEVPN via **cloud-init**: each instance installs non-interactively and
...
PRIMEVPN non-interactively and generates unique per-instance credentials.
...
is essentially a documented cloud-init config plus metadata. To propose PRIMEVPN as
