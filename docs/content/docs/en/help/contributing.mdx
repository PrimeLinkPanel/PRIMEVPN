---
title: Contributing
description: How to contribute to PRIMEVPN and to translate this documentation.
icon: GitPullRequestArrow
---

PRIMEVPN is community-driven. Contributions to the panel and to these docs are
welcome.

## Support the developer

PRIMEVPN is free and open source, built and maintained in the open. If it's useful
...
- **Star** the [repository](https://github.com/sh7CBAC/PRIMEVPN) and share the
  project.
- **Join** the Telegram channel [@XrayUI](https://t.me/XrayUI) to follow news and
  help others.

## Contribute to PRIMEVPN

- Read the project's `CONTRIBUTING.md` in the
  [repository](https://github.com/sh7CBAC/PRIMEVPN).
