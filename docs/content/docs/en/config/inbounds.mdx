...
description: Create inbounds in PRIMEVPN — protocols, transports, traffic reset and expiry, and fallbacks that serve multiple protocols on one port.
...
inbound. In PRIMEVPN, fallbacks are managed in the panel (a master inbound's
