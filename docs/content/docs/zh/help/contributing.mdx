---
title: 参与贡献
description: 如何为 PRIMEVPN 贡献代码并翻译本文档。
icon: GitPullRequestArrow
---

PRIMEVPN 由社区驱动。我们欢迎你为面板和这些文档做出贡献。

## 支持开发者

PRIMEVPN 是免费且开源的，完全在公开环境中构建与维护。如果它对你有帮助，欢迎
考虑支持其持续开发：

- 前往 [donate.sanaei.dev](https://donate.sanaei.dev/) **捐赠**——该页面会展示
  当前的资金**目标与进度**，你可以一同助力达成。
- 为[仓库](https://github.com/sh7CBAC/PRIMEVPN)点 **Star**，并分享这个
  项目。
...
- 阅读[仓库](https://github.com/sh7CBAC/PRIMEVPN)中项目的 `CONTRIBUTING.md`。
