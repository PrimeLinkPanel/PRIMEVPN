---
title: Migration
description: Migrate to PRIMEVPN from x-ui, between servers, or between PRIMEVPN versions.
icon: ArrowRightLeft
---
...
Importing an older x-ui panel's database directly into PRIMEVPN is **not
