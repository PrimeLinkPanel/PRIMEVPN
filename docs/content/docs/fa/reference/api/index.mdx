---
title: مرجع API
description: REST API پنل PRIMEVPN — احراز هویت، inboundها، کلاینت‌ها، آمار سرور و موارد دیگر، تولیدشده از مشخصات OpenAPI.
icon: Webhook
---

پنل PRIMEVPN یک REST API برای خودکارسازی در اختیار می‌گذارد. این صفحات از مشخصات
