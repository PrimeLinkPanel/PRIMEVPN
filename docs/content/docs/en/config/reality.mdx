---
title: REALITY
description: Set up a VLESS + REALITY inbound with XTLS-Vision in PRIMEVPN — keys, short IDs, SNI, fingerprints, and common pitfalls.
icon: ShieldCheck
---
...
When you choose **REALITY** as the security mode on a VLESS inbound, PRIMEVPN
