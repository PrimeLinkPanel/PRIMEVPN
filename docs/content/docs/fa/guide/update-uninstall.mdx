...
description: مدیریت PRIMEVPN با منوی x-ui و خط فرمان — به‌روزرسانی پایدار یا dev، تغییر تنظیمات و حذف تمیز و کامل.
icon: RefreshCw
---
...
| `x-ui legacy`              | با خطا برمی‌گردد؛ نصب نسخهٔ قدیمی upstream غیرفعال است     |
...
| `x-ui pgclient [ver]`      | نصب یا ارتقای ابزارهای کلاینت PostgreSQL                   |
