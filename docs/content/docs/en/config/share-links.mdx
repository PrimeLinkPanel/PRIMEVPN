---
title: Share Links
description: PRIMEVPN share-link formats (vless, vmess, trojan, ss, hysteria2, mtproto), the remark template variables, and an in-browser link inspector.
icon: Link
---

PRIMEVPN generates a **share link** (and QR code) for each client. Client apps such
