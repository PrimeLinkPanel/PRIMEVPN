import * as DropdownMenuPrimitive from '@radiprimevpn/react-dropdown-menu'
    ...
    return (
      <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
          ...
          {...props}
          // @ts-expect-error Radix DropdownMenu.Content accepts dir at runtime, but its exported prop type does not expose it.
          dir={dir}
        />
      </DropdownMenuPrimitive.Portal>
    )
