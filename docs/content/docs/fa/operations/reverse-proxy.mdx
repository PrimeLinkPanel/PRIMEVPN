---
title: پراکسی معکوس
description: قرار دادن پنل و اشتراک PRIMEVPN پشت Nginx یا Caddy همراه با TLS از Let's Encrypt.
icon: Waypoints
---
...
[منوی SSL در `primevpn`](/docs/config/ssl-certificates) دریافت کنید.
