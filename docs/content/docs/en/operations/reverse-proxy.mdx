---
title: Reverse Proxy
description: Put the PRIMEVPN panel and subscription behind Nginx or Caddy with Let's Encrypt TLS.
icon: Waypoints
---
...
[`primevpn` SSL menu](/docs/config/ssl-certificates) instead.
