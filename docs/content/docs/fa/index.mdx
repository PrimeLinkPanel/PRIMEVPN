---
title: مستندات PRIMEVPN
description: مستندات رسمی PRIMEVPN — یک پنل وب پیشرفته برای مدیریت سرورهای Xray-core، پروکسی‌ها، کلاینت‌ها و سابسکریپشن‌ها.
icon: House
---

**PRIMEVPN** یک پنل وب متن‌باز برای استقرار و مدیریت سرورهای
...
<Callout type="info">
  با Xray تازه آشنا شده‌اید؟ ابتدا [PRIMEVPN چیست؟](/docs/guide) را بخوانید — توضیح می‌دهد که پنل، Xray-core و
